...
public class AddressBook implements ActionListener {
...

  {
    ...
    menuItem = new JMenuItem("Add an entry");
    menu.add(menuItem);
    menuItem.addActionListener(this);

    menuItem = new JMenuItem("Remove an entry");
    menu.add(menuItem);
    menuItem.addActionListener(this);

    menuItem = new JMenuItem("Search entries");
    menu.add(menuItem);
    menuItem.addActionListener(this);

    menuItem = new JMenuItem("Sort entries");
    menu.add(menuItem);
    menuItem.addActionListener(this);

    menuItem = new JMenuItem("Print Address Book");
    menu.add(menuItem);
    menuItem.addActionListener(this);

    menuItem = new JMenuItem("Save Address Book to file");
    menu.add(menuItem);
    menuItem.addActionListener(this);
    ...
    JButton AddNew = new JButton("Add an entry");
    JButton DeleteContact = new JButton("Remove an entry");
    JButton SearchContacts = new JButton("Search entries");
    JButton SortContacts = new JButton("Sort entries");
    JButton ViewContactList = new JButton("Print Address Book");

    JLabel label = new JLabel(
            "<HTML><FONT FACE = ARIAL SIZE = 4><B>Use The options below and In The Options Menu to Manage the Address Book");
    ...
    frame.setResizable(true);//frame.setResizable(false);
  ...
  {
    if(actionEvent.getActionCommand() == "Add an entry")
    {
      operationHandler.AddNew();

    }

    else  if(actionEvent.getActionCommand() == "Search entries")
    {
      operationHandler.SearchContacts();

    }

    else  if(actionEvent.getActionCommand() == "Sort entries")
    {
      operationHandler.SortContacts();

    }

    else  if(actionEvent.getActionCommand() == "Remove an entry")
    {
      operationHandler.DeleteContact();

    }

    else  if(actionEvent.getActionCommand() == "Print Address Book")
    {

      operationHandler.ViewAllContacts();

    }

    else  if(actionEvent.getActionCommand() == "About")
    {
      JOptionPane.showMessageDialog(frame, "Address Book created by IOF (Internet of Friends");
    ...
    else  if(actionEvent.getActionCommand() == "Save Address Book to file")
    {
...
class OperationHandler implements ListSelectionListener, ActionListener, Runnable {
  ...
  public void AddNew() {
    ...
    newFrame.setSize(320, 350);//newFrame.setSize(220, 250);
  ...
  {
    newFrame = new JFrame("Search entries");
    newFrame.setSize(880,220);
    newFrame.setLocation(screenWidth/4, screenHeight/4);
    newFrame.setIconImage(img);
    newFrame.setResizable(true);//newFrame.setResizable(false);
  ...
  public void actionPerformed(ActionEvent actionEvent)
  {
    ...
    if(actionEvent.getActionCommand() == "Add New!")
    {
    ...
    else if(actionEvent.getActionCommand() == "Save Added!")
    {
    ...
    else if(actionEvent.getActionCommand() == "Delete Selected")
    {
